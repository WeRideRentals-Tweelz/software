			...
			<div class="row" style="border-bottom: 1px silver solid;padding: 50px 0px">
					...
					<div class="row" style="padding: 50px 0px">
						<div class="media">
							<div class="media-left media-middle">
								<a href="#">
									<img style="height: 120px; width: 120px;" src="<?php echo e(asset('images/user.png')); ?>" alt="Facebook Post Image" class="media-object">
								</a>
							</div>
				...
				<div class="col-md-4">
					...
					<div class="row" style="padding: 50px 0px">
						<div class="col-md-6">
							<div class="thumbnail">
								<img src="<?php echo e(asset('images/scooter.jpg')); ?>" alt="Scooter Picture">
								<div class="caption">
									<h4>Product label</h4>
					...
					<div class="row">
						<p style="text-align: center"><a href="<?php echo e(url('/scooters')); ?>" class="btn btn-primary" role="button">View all models</a></p>
					</div>
				</div>
			</div>
			<div class="row" style="padding: 50px 0px">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="thumbnail">
							<img src="<?php echo e(asset('images/partner.png')); ?>" alt="our partner">
							<div class="caption">
