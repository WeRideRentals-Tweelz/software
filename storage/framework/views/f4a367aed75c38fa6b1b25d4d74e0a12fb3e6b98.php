<div class="row">
	<div class="container-fluid" style="height:100vh">
		<div class="row hidden-xs" style="height: 1900px">
			<img src="<?php echo e(asset('images/scooter.jpeg')); ?>" style="max-height: 1200px;height:100vh;min-height:900px;width: 100%;margin-top: -200px">
		</div>
			...
			<div class="container">
				<form class="form-inline" action="/rent-a-scooter" method="POST">
					<div class="row">
						...
						<input type="date" name="pick_up_date" placeholder="Pick Up Date" class="form-control" required>
						<input type="date" name="drop_off_date" placeholder="Drop Off Date" class="form-control" required>
					</div>
					<div class="col-xs-4 col-xs-offset-2 col-sm-offset-5" style="margin-top: 25px">
						<button type="submit" class="btn btn-primary">Ask for a meeting to rent a scooter</button>
					</div>
				</form>
			</div>
		</div>
