<div class="row">
	<div class="container-fluid" style="height:100vh">
		<div class="row hidden-xs" style="height: 1900px">
			<img src="<?php echo e(asset('images/scooter.jpeg')); ?>" alt="rent a scooter in sydney" style="max-height: 1200px;height:100vh;min-height:900px;width: 100%;margin-top: -200px">
		</div>
