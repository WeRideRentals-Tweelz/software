<?php $__env->startSection('content'); ?>
	<div class="container" style="min-height: 670px;">
		<div class="row">
			...
			<p>We confirm you're reservation of a <B><?php echo e(ucfirst($scooter->model)); ?></B> for the <B><?php echo e(date_format(date_create($pick_up_date),'d/m/Y')); ?></B> to the <b><?php echo e(date_format(date_create($drop_off_date),'d/m/Y')); ?></b>.</p>
			...
			<p><a href="<?php echo e(url('/')); ?>" class="btn btn-primary">Return on home page</a></p>
		</div>
	</div>
