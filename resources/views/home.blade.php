	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="hidden-sm hidden-md hidden-lg">
				<img class="headerXS" src="{{ asset('images/scooter.jpeg') }}" alt="rent a scooter in Sydney" style="width: 100%; margin-top: -125px">
			</div>
		</div>
		...
		<div class="container second-screen">
				<div style="border-bottom: 1px silver solid; padding: 50px 0px;">
					<div class="container-fluid">
						...
						<div class="col-sm-4">
							<div class='thumbnail'>
								<img src="{{ asset('images/asset1.jpeg') }}" style="width: 100%;height: 220px" alt="beat the traffic">
								<div class="caption">
						...
						<div class="col-sm-4">
							<div class='thumbnail'>
								<img src="{{ asset('images/asset2.jpeg') }}" alt="save money" style="width: 100%;height: 220px">
								<div class="caption">
						...
						<div class="col-sm-4">
							<div class='thumbnail'>
								<img src="{{ asset('images/asset3.jpeg') }}" alt="stay independant" style="width: 100%; height: 220px">
								<div class="caption">
