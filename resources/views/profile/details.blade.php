		...
		<div class="col-sm-6 col-sm-offset-1">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form" action="/profile/{{ $user->id }}/update" method="POST" enctype="multipart/form-data">
	  ...
	  <div class="modal-dialog">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-footer" style="min-height: 150px">
	      	...
	      	<form id="signForm" action="/profile/{{ $user->id }}/signed" method="POST" class="hidden">
	      		{{ csrf_field() }}
	      		<input type="hidden" name="userId" value="{{ $user->id }}">
		    ...
		    <br>
		    <br>
		    <button type="button" class="btn btn-danger btn-block" data-dismiss="modal">I don't want to sign this</button>
	      </div>
	    </div>
